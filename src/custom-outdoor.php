...
<?php
$query = query("SELECT * FROM service_info WHERE id = 1");
confirm($query);
        ...
        <div class="upper-content">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Bếp ăn ngoài trời</li>
                </ol>
            </nav>
        ...
        <div class="lower-content-article">
            ...
            <div class="row img-collection">
                <div class="col-md-3 collect-1">
                    <img src="images/kitchen/kitchen_1.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-md-3 collect-1">
                    <img src="images/kitchen/kitchen_2.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-md-3 collect-1">
                    <img src="images/kitchen/kitchen_3.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-md-3 collect-1">
                    <img src="images/kitchen/kitchen_4.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-md-3 collect-1">
