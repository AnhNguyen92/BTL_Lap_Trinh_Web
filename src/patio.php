...
<?php
$query = query("SELECT * FROM service_info WHERE id = 3");
confirm($query);
...
?>
    <div class="col-md-9 content-right">
        <div class="upper-content">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Sân trong</li>
                </ol>
            </nav>
        ...
        <div class="lower-content-article">
            ...
            <!-- <h1 class="main-title">CUSTOM PATIO</h1> -->
            <div class="row img-collection">
                <div class="col-md-3 collect-1">
                    <img src="images/patio/patio_1.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-md-3 collect-1">
                    <img src="images/patio/patio_2.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-md-3 collect-1">
