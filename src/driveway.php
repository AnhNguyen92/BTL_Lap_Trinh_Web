...
<?php
$query = query("SELECT * FROM service_info WHERE id = 2");
confirm($query);
        ...
        <div class="upper-content">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Lối đi</li>
                </ol>
            </nav>
        ...
        <div class="lower-content-article">
            ...
            <div class="row img-collection">
                <div class="col-md-3 collect-1">
                    <img src="images/driveway/driveway_1.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-md-3 collect-1">
